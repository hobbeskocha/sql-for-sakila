...
create or replace view revenues_and_volume as 
	select f.film_id, f.title, f.rental_duration, f.rating, sum(p.amount) as total_revenue, count(r.rental_id) as rental_volume
